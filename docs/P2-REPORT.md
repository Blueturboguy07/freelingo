...
corrections, at 212.36 s, cleared by a single `--failed` re-run — which took the tally to
**3 failures in 7 attempts** and turned the speed correlation from a hypothesis into an
out-of-sample prediction that held. `docs/P2-BLOCKERS.md` §B20 carries the full table.
